...
loadInstance = function(map, instanceName)
	...
	if (instanceName == "ruins") then
		...
		setMap(map + 1, mapFile.."instances/ruins/r2_ruins_eastwing.map", "East Wing", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		setMap(map + 2, mapFile.."instances/ruins/r2_ruins_westwing.map", "West Wing", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		setMap(map + 3, mapFile.."instances/ruins/r2_ruins_hall.map", "Hoary Hallway", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		setMap(map + 4, mapFile.."instances/ruins/r2_ruins_passage_nostairs.map", "Precarious Passage", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		warpFile = warpFile.."region2/ruins.txt"
	elseif (instanceName == "canidae") then
		setMap(map, mapFile.."instances/canidae/r2_ce_merry.map", "Merry Forest", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		setMap(map + 1, mapFile.."instances/canidae/r2_ce_cheerful.map", "Cheerful Forest", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		setMap(map + 2, mapFile.."instances/canidae/r2_ce_joyous.map", "Joyous Forest", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		setMap(map + 3, mapFile.."instances/canidae/r2_ce_glade.map", "Glade", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		setMap(map + 4, mapFile.."instances/canidae/r2_ce_twisting.map", "Twisting Pine", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		setMap(map + 5, mapFile.."instances/canidae/r2_ce_clearing.map", "Clearing", 113, 0, 1, 0, 0, 3600000, 0, 0, 2, 1, 0, 0)
		warpFile = warpFile.."region2/canidae.txt"
	elseif (instanceName == "strengthTrial") then
		setMap(map, mapFile.."end/trials/trial_of_strength_and_wits.map", "Trial of Strength and Wits", 160, 0, 1, 0, 0, 3600000, 0, 0, 66, 1, 0, 0)
		warpFile = warpFile.."region2/canidae.txt"
