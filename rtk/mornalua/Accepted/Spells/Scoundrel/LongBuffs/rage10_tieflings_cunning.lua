...
--                  . . . 
-------------------------------------------------------
--    Desc: 50x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_tieflings_cunning"] = 1

end,
on_forget = function(player) player.registry["learned_tieflings_cunning"] = 0 end,

cast = function(player)

	local magicCost = 60000
	local duration = 600000
	local sound = 31
	local anim = 35

	if not player:canCast(1,1,0) then return end
	if player:hasDuration("tieflings_cunning") then player:setDuration("tieflings_cunning", 0) return end	
	...
	player:setDuration("tieflings_cunning", duration)
	player:calcStat()
	player:sendMinitext("You cast Tiefling's Cunning")
end,
...
requirements = function(player)
	...
	local desc = {"Tiefling's Cunning is a stronger version of Reaper's Cunning.", txt}
