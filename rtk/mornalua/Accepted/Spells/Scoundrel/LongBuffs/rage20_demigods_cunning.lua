...
--                  . . . 
-------------------------------------------------------
--    Desc: 225x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_demigods_cunning"] = 1

end,
on_forget = function(player) player.registry["learned_demigods_cunning"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("demigods_cunning") then player:setDuration("demigods_cunning", 0) return end	
	...
	player:setDuration("demigods_cunning", duration)
	player:calcStat()
	player:sendMinitext("You cast Demigod's Cunning")
end,
...
requirements = function(player)
	...
	local desc = {"Demigod's Cunning is a stronger version of Immortal's Cunning.", txt}
