...
on_forget = function(player) player.registry["learned_armadillos_endurance"] = 0 end,
...
cast = function(player, target)
	...
	if player:hasDuration("armadillos_endurance") then alreadyCast(player) return end
