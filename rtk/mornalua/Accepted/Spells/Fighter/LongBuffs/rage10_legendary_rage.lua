...
--                 . . X . .
-------------------------------------------------------
--    Desc: 26x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_legendary_rage"] = 1
end,
on_forget = function(player) player.registry["learned_legendary_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("legendary_rage") then player:setDuration("legendary_rage", 0) return end	
	...
	player:setDuration("legendary_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Legendary Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Legendary Rage is a stronger version of Exalted Rage.", txt}
