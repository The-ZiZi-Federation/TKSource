...
--                 . . X . .
-------------------------------------------------------
--    Desc: 52x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_cosmic_rage"] = 1
end,
on_forget = function(player) player.registry["learned_cosmic_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("cosmic_rage") then player:setDuration("cosmic_rage", 0) return end	
	...
	player:setDuration("cosmic_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Cosmic Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Cosmic Rage is a stronger version of Phenomenal Rage.", txt}
