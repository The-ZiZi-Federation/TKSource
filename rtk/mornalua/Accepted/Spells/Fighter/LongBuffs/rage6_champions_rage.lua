...
on_learn = function(player) player.registry["learned_champions_rage"] = 1
end,
on_forget = function(player) player.registry["learned_champions_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("champions_rage") then player:setDuration("champions_rage", 0) return end	
...
requirements = function(player)
	...
	local desc = {"Champion's Rage is a stronger version of Fighter's Rage.", txt}
