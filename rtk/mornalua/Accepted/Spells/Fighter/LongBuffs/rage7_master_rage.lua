...
on_learn = function(player) player.registry["learned_master_rage"] = 1
end,
on_forget = function(player) player.registry["learned_master_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("master_rage") then player:setDuration("master_rage", 0) return end	
