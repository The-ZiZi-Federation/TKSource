...
--                 . . X . .
-------------------------------------------------------
--    Desc: 82x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_dragons_rage"] = 1
end,
on_forget = function(player) player.registry["learned_dragons_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("dragons_rage") then player:setDuration("dragons_rage", 0) return end	
	...
	player:setDuration("dragons_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Dragon's Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Dragon's Rage is a stronger version of Totem's Rage.", txt}
