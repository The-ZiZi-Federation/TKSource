...
on_learn = function(player) player.registry["learned_conscripts_rage"] = 1 
end,
on_forget = function(player) player.registry["learned_conscripts_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("conscripts_rage") then player:setDuration("conscripts_rage", 0) return end	
