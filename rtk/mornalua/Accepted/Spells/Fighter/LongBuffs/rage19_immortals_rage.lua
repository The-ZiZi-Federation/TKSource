...
--                 . . X . .
-------------------------------------------------------
--    Desc: 107x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_immortals_rage"] = 1
end,
on_forget = function(player) player.registry["learned_immortals_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("immortals_rage") then player:setDuration("immortals_rage", 0) return end	
	...
	player:setDuration("immortals_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Immortal's Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Immortal's Rage is a stronger version of Spirit's Rage.", txt}
