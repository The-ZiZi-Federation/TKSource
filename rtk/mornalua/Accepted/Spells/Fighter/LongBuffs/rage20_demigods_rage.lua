...
--                 . . X . .
-------------------------------------------------------
--    Desc: 121x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_demigods_rage"] = 1
end,
on_forget = function(player) player.registry["learned_demigods_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("demigods_rage") then player:setDuration("demigods_rage", 0) return end	
	...
	player:setDuration("demigods_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Demigod's Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Demigod's Rage is a stronger version of Immortal's Rage.", txt}
