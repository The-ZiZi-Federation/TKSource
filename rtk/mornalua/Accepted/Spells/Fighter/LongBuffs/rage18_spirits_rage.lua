...
--                 . . X . .
-------------------------------------------------------
--    Desc: 94x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_spirits_rage"] = 1
end,
on_forget = function(player) player.registry["learned_spirits_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("spirits_rage") then player:setDuration("spirits_rage", 0) return end	
	...
	player:setDuration("spirits_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Spirit's Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Spirit's Rage is a stronger version of Dragon's Rage.", txt}
