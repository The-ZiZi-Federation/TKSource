...
--                 . . X . .
-------------------------------------------------------
--    Desc: 18x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_heroic_rage"] = 1
end,
on_forget = function(player) player.registry["learned_heroic_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("heroic_rage") then player:setDuration("heroic_rage", 0) return end	
	...
	player:setDuration("heroic_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Heroic Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Heroic Rage is a stronger version of Master Rage.", txt}
