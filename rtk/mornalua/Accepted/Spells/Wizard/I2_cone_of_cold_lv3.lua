...
on_learn = function(player) player.registry["learned_cone_of_cold_lv3"] = 1
	player:removeSpell("cone_of_cold_lv1") 
	player:removeSpell("cone_of_cold_lv2") 
	player:removeSpell("cone_of_cold_lv4") 
end,
on_forget = function(player) player.registry["learned_cone_of_cold_lv3"] = 0 end,
...
------------------------------------
	...
	player:setAether("cone_of_cold_lv3", aether)
	player:sendMinitext("You cast Cone of Cold Lv3")
	if player.registry["extra_spell_info"] == 1 then
		player:sendMinitext("Cone of Cold Lv3 DMG: "..damage)
	end
	...
	local r = math.random(1,1000)
		...
		elseif (pcTargets[i] ~= nil) then
			if (player:canPK(pcTargets[i])) then
				...
				pcTargets[i]:sendMinitext(player.name.." chills you with Cone of Cold Lv3")
				if r <= 50 then 
...
requirements = function(player)
	...
	local desc = {"Cone of Cold Lv3 will send a cone of ice in front of you, chilling your enemies!\n\nReplaces Cone of Cold Lv2", txt}
