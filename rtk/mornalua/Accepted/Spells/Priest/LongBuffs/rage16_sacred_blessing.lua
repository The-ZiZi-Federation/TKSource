...
on_learn = function(player) player.registry["learned_sacred_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_sacred_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("sacred_blessing") then player:setDuration("sacred_blessing", 0) return end	
	...
	player:setDuration("sacred_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Sacred Blessing")
...
requirements = function(player)
	...
	local desc = {"Sacred Blessing is a stronger version of Marvelous Blessing.", txt}
