...
on_learn = function(player) player.registry["learned_divine_blessing"] = 1
end,
on_forget = function(player) player.registry["learned_divine_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("divine_blessing") then player:setDuration("divine_blessing", 0) return end	
	...
	player:setDuration("divine_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Divine Blessing")
...
requirements = function(player)
	...
	local desc = {"Divine Blessing is a stronger version of Sacred Blessing.", txt}
