...
on_learn = function(player) player.registry["learned_immortals_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_immortals_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("immortals_blessing") then player:setDuration("immortals_blessing", 0) return end	
	...
	player:setDuration("immortals_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Immortal's Blessing")
...
requirements = function(player)
	...
	local desc = {"Immortal's Blessing is a stronger version of Spirit's Blessing.", txt}
