...
on_learn = function(player) player.registry["learned_heralds_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_heralds_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("heralds_blessing") then player:setDuration("heralds_blessing", 0) return end	
	...
	player:setDuration("heralds_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Herald's Blessing")
...
requirements = function(player)
	...
	local desc = {"Herald's Blessing is a stronger version of Missionary's Blessing.", txt}
