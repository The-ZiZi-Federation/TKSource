...
on_learn = function(player) player.registry["learned_celestials_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_celestials_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("celestials_blessing") then player:setDuration("celestials_blessing", 0) return end	
	...
	player:setDuration("celestials_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Celestial's Blessing")
...
requirements = function(player)
	...
	local desc = {"Celestial's Blessing is a stronger version of Seraph's Blessing.", txt}
