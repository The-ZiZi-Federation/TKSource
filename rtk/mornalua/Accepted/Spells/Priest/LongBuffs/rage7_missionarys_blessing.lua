...
on_learn = function(player) player.registry["learned_missionarys_blessing"] = 1
end,
on_forget = function(player) player.registry["learned_missionarys_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("missionarys_blessing") then player:setDuration("missionarys_blessing", 0) return end	
