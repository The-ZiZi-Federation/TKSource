...
on_learn = function(player) player.registry["learned_marvelous_blessing"] = 1
end,
on_forget = function(player) player.registry["learned_marvelous_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("marvelous_blessing") then player:setDuration("marvelous_blessing", 0) return end	
	...
	player:setDuration("marvelous_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Marvelous Blessing")
...
requirements = function(player)
	...
	local desc = {"Marvelous Blessing is a stronger version of Otherworldly Blessing.", txt}
