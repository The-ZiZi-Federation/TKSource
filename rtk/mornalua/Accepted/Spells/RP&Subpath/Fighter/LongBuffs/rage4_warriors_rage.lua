...
--    Type: Rage Bonus
-- Targets: Self
-- Effects: Rage Mult: 7x
--        : Flank
--					. X .
--                  X P X
--                  . X . 
-------------------------------------------------------
--    Desc: 7x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_warriors_rage"] = 1
end,
on_forget = function(player) player.registry["learned_warriors_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("warriors_rage") then player:setDuration("warriors_rage", 0) return end	
...
requirements = function(player)
	...
	local desc = {"Warrior's Rage is a stronger version of Brawler's Rage.", txt}
