...
--                 . . X . .
-------------------------------------------------------
--    Desc: 37x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_superhuman_rage"] = 1
end,
on_forget = function(player) player.registry["learned_superhuman_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("superhuman_rage") then player:setDuration("superhuman_rage", 0) return end	
	...
	player:setDuration("superhuman_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Superhuman Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Superhuman Rage is a stronger version of Mythic Rage.", txt}
