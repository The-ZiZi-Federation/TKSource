...
--                 . . X . .
-------------------------------------------------------
--    Desc: 135x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_deitys_rage"] = 1
end,
on_forget = function(player) player.registry["learned_deitys_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("deitys_rage") then player:setDuration("deitys_rage", 0) return end	
	...
	player:setDuration("deitys_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Deity's Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Deity's Rage is a stronger version of Demigod's Rage.", txt}
