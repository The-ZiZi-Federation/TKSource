...
--                 . . X . .
-------------------------------------------------------
--    Desc: 31x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_mythic_rage"] = 1
end,
on_forget = function(player) player.registry["learned_mythic_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("mythic_rage") then player:setDuration("mythic_rage", 0) return end	
	...
	player:setDuration("mythic_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Mythic Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Mythic Rage is a stronger version of Legendary Rage.", txt}
