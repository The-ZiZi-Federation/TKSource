...
on_learn = function(player) player.registry["learned_fighters_rage"] = 1
end,
on_forget = function(player) player.registry["learned_fighters_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("fighters_rage") then player:setDuration("fighters_rage", 0) return end	
...
requirements = function(player)
	...
	local desc = {"Fighter's Rage is a stronger version of Warrior's Rage.", txt}
