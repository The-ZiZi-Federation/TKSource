...
--                 . . X . .
-------------------------------------------------------
--    Desc: 44x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_phenomenal_rage"] = 1
end,
on_forget = function(player) player.registry["learned_phenomenal_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("phenomenal_rage") then player:setDuration("phenomenal_rage", 0) return end	
	...
	player:setDuration("phenomenal_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Phenomenal Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Phenomenal Rage is a stronger version of Superhuman Rage.", txt}
