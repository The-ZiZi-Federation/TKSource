...
--                 . . X . .
-------------------------------------------------------
--    Desc: 22x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_exalted_rage"] = 1
end,
on_forget = function(player) player.registry["learned_exalted_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("exalted_rage") then player:setDuration("exalted_rage", 0) return end	
	...
	player:setDuration("exalted_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Exalted Rage")
end,
...
requirements = function(player)
	...
	local desc = {"Exalted Rage is a stronger version of Heroic Rage.", txt}
