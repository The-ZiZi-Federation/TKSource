...
on_learn = function(player) player.registry["learned_brawlers_rage"] = 1
end,
on_forget = function(player) player.registry["learned_brawlers_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("brawlers_rage") then player:setDuration("brawlers_rage", 0) return end	
