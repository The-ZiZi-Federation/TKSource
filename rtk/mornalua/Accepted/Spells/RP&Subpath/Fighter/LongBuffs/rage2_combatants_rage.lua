...
--
-------------------------------------------------------
--    Desc: Triple your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_combatants_rage"] = 1
end,
on_forget = function(player) player.registry["learned_combatants_rage"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("combatants_rage") then player:setDuration("combatants_rage", 0) return end	
	...
	player:setDuration("combatants_rage", duration)
	player:calcStat()
	player:sendMinitext("You cast Combatant's Rage")
...
requirements = function(player)
	...
	local desc = {"Combatant's Rage is a stronger version of Conscript's Rage.", txt}
