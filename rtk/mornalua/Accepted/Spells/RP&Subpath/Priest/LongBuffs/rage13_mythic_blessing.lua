...
on_learn = function(player) player.registry["learned_mythic_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_mythic_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("mythic_blessing") then player:setDuration("mythic_blessing", 0) return end	
	...
	player:setDuration("mythic_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Mythic Blessing")
...
requirements = function(player)
	...
	local desc = {"Mythic Blessing is a stronger version of Celestial's Blessing.", txt}
