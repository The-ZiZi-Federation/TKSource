...
--
-------------------------------------------------------
--    Desc: 4x your damage output to swing and spells while cast.
...
on_learn = function(player) player.registry["learned_apostles_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_apostles_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("apostles_blessing") then player:setDuration("apostles_blessing", 0) return end	
	...
	player:setDuration("apostles_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Apostle's Blessing")
...
requirements = function(player)
	...
	local desc = {"Apostle's Blessing is a stronger version of Shepherd's Blessing.", txt}
