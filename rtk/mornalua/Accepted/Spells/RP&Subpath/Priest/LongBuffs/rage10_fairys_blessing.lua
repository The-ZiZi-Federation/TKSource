...
on_learn = function(player) player.registry["learned_fairys_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_fairys_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("fairys_blessing") then player:setDuration("fairys_blessing", 0) return end	
	...
	player:setDuration("fairys_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Fairy's Blessing")
...
requirements = function(player)
	...
	local desc = {"Fairy's Blessing is a stronger version of Prophet's Blessing.", txt}
