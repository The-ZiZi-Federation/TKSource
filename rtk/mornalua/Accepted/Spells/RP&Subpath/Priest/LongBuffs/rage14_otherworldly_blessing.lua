...
-------------------------------------------------------
otherworldly_blessing = {

on_learn = function(player) player.registry["learned_otherworldly_blessing"] = 1
end,
on_forget = function(player) player.registry["learned_otherworldly_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("otherworldly_blessing") then player:setDuration("otherworldly_blessing", 0) return end	
	...
	player:setDuration("otherworldly_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Otherworldly Blessing")
...
requirements = function(player)
	...
	local desc = {"Otherworldly Blessing is a stronger version of Mythic Blessing.", txt}
