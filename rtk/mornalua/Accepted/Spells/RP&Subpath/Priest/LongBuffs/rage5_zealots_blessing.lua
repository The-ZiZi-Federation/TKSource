...
on_learn = function(player) player.registry["learned_zealots_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_zealots_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("zealots_blessing") then player:setDuration("zealots_blessing", 0) return end	
	...
	player:setDuration("zealots_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Zealot's Blessing")
...
requirements = function(player)
	...
	local desc = {"Zealot's Blessing is a stronger version of Disciple's Blessing.", txt}
