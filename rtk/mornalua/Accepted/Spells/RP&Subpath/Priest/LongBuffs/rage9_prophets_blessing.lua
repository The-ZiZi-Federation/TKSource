...
on_learn = function(player) player.registry["learned_prophets_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_prophets_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("prophets_blessing") then player:setDuration("prophets_blessing", 0) return end	
	...
	player:setDuration("prophets_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Prophet's Blessing")
...
requirements = function(player)
	...
	local desc = {"Prophet's Blessing is a stronger version of Herald's Blessing.", txt}
