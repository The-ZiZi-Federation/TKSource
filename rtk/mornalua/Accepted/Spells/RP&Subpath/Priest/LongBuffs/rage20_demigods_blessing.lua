...
on_learn = function(player) player.registry["learned_demigods_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_demigods_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("demigods_blessing") then player:setDuration("demigods_blessing", 0) return end	
	...
	player:setDuration("demigods_blessing", duration)
	player:calcStat()
	player:sendMinitext("You cast Demigod's Blessing")
...
requirements = function(player)
	...
	local desc = {"Demigod's Blessing is a stronger version of Immortal's Blessing.", txt}
