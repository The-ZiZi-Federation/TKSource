...
on_learn = function(player) player.registry["learned_shepherds_blessing"] = 1

end,
on_forget = function(player) player.registry["learned_shepherds_blessing"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("shepherds_blessing") then player:setDuration("shepherds_blessing", 0) return end	
