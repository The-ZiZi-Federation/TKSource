...
on_learn = function(player) player.registry["learned_catspaws_cunning"] = 1
end,
on_forget = function(player) player.registry["learned_catspaws_cunning"] = 0 end,
...
cast = function(player)
	...
	if player:hasDuration("catspaws_cunning") then player:setDuration("catspaws_cunning", 0) return end	
	...
	player:setDuration("catspaws_cunning", duration)
	player:calcStat()
	player:sendMinitext("You cast Catspaw's Cunning")
end,
...
requirements = function(player)
	...
	local desc = {"Catspaw's Cunning is a stronger version of Burglar's Cunning.", txt}
