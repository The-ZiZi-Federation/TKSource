...
on_learn = function(player) player.registry["learned_burning_hands_lv2"] = 1
	player:removeSpell("burning_hands_lv1") 
	player:removeSpell("burning_hands_lv3") 
	player:removeSpell("burning_hands_lv4") 
end,
on_forget = function(player) player.registry["learned_burning_hands_lv2"] = 0 end,
...
------------------------------------
	...
	player:setAether("burning_hands_lv2", aether)
	player:sendMinitext("You cast Burning Hands Lv2")
	if player.registry["extra_spell_info"] == 1 then
		player:sendMinitext("Burning Hands Lv2 DMG: "..damage)
	end
	...
	local r = math.random(1,1000)
		...
		elseif (pcTargets[i] ~= nil) then
			if (player:canPK(pcTargets[i])) then
				...
				pcTargets[i]:sendMinitext(player.name.." burns you with Burning Hands Lv2")
				if r <= 50 then 
...
requirements = function(player)
	...
	local desc = {"Burning Hands Lv2 will send a cone of fire infront of you burning your enemies alive!\n\nReplaces Burning Hands Lv1", txt}
