...
-------------------------------------------------------
power_attack_lv2_sam = {
on_learn = function(player) player.registry["power_attack_lv2_sam"]=1 end,
on_forget = function(player) player.registry["power_attack_lv2_sam"]=0 end,
...
------------------------------------
	if mobTarget ~= nil then
		player.critChance = 1
		damage = ((0.025 * player.maxHealth) + (0.1 * player.level)+ swingDamage(player, mobTarget, 2)) * 18
		...
		player:setAether("power_attack_lv2_sam", aether)
