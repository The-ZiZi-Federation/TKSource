...
on_learn = function(player) player.registry["learned_taunt_merc"] = 1 end,
on_forget = function(player) player.registry["learned_taunt_merc"] = 0 end,
...
---------------------------------------------	
	if (target.blType == BL_MOB) then
		...
		player:setAether("taunt_merc", aether)
		player:sendStatus()
