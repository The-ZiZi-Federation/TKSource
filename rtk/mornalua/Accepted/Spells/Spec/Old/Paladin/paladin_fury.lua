...
on_learn = function(player) 
	...
	player.registry["learned_paladin_fury"] = 1 
...
on_forget = function(player) 
	...
	player.registry["learned_paladin_fury"] = 0 
end,
...
cast = function(player)
	...
	if player:hasDuration("combat_awareness") or player:hasDuration("combat_intuition") or player:hasDuration("combat_affinity") or player:hasDuration("combat_devotion") or player:hasDuration("paladin_fury") then
		anim(player)
		player:sendMinitext("Spell is already cast!")
	return else
		if player.fury < 4 then
			player:setDuration("paladin_fury", dura)
			...
			player:playSound(9)
			player:sendMinitext("You cast Paladin Fury")
		end
	end
end,
