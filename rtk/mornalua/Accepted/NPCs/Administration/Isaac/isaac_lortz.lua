...
click = async(function(player,npc)
	...
	if player.registry["lortz_village_eye"] == 0 then table.insert(opts, "How can I use this eye?") end
	if player.registry["lortz_village_eye"] == 1 then table.insert(opts, "See you around!") end
	...
	elseif menu == "How can I use this eye?" then
			...
			player.registry["lortz_village_eye"] = 1
			player:addLegend("Found the Eye of Teleportation for Lortz Territory "..curT(), "lortz_eye_open", 202, 202)
			player:msg(4, "[Unlocked Lortz Village Eye of Teleportation]", player.ID)
