...
click = async(function(player,npc)
	...
	if player.class == crusader and player.mark < 1 and (player.baseHealth >= 457500 or player.baseMagic >= 457500) then table.insert(opts, "Rank 1") end
	--if player.class == crusader and player.mark < 2 and (player.baseHealth >= 1197500 or player.baseMagic >= 1197500) then table.insert(opts, "Rank 2") end
	--if player.class == crusader and player.mark < 3 and (player.baseHealth >= 1970000 or player.baseMagic >= 1970000) then table.insert(opts, "Rank 3") end
	--if player.class == crusader and player.mark < 4 and (player.baseHealth >= 3020000 or player.baseMagic >= 3020000) then table.insert(opts, "Rank 4") end
	--if player.class == crusader and player.mark < 5 and (player.baseHealth >= 4257500 or player.baseMagic >= 4257500) then table.insert(opts, "Rank 5") end
	--if player.class == crusader and player.mark < 5 and (player.baseHealth >= 5682500 or player.baseMagic >= 5682500) then table.insert(opts, "Rank 6") end	

	if player.baseClass == 4 and player.class < 5 then table.insert(opts, "I want to be a Crusader") end
	
	if player.class == crusader then
...
-- Join Path
	if menu == "I want to be a Crusader" then
		...
		elseif player.level == 110 then
			player:dialogSeq({t, name.."It is not everyday someone comes in these doors looking to join the fight against evil.",
								name.."I wont lie to you. It feel's like the world is losing to evil.",
								name.."If you join this fight, you are in it for life. FOR ASAK!"}, 1)
			confirm = player:menuString("Are you sure you want to be a Crusader. You can not undo this choice!", {"Yes", "No"})
            if confirm == "Yes" then
				player:dialogSeq({t, name.."Well now it's about to be official. All Seeing All Knowing God. With all your infinite wisdom!",
									name.."I call upon you to annoint this new soldier to the cause. Let's fight Evil EVERYWHERE!"}, 1)
				broadcast(-1, "[Congratulations] "..player.name.." is now a Warpriest!")
				specRebirth(player,  crusader)
