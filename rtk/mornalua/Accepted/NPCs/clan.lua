...
click = async(function(player, npc)
	...
	table.insert(options, "ShowClanBank")
	table.insert(options, "ShowClanBankAdd")
	...
	elseif choice == "ShowClanBank" then
		player:showClanBank("Clan Bank")
	elseif choice == "ShowClanBankAdd" then
