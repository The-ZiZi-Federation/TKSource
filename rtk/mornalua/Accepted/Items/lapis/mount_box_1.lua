...
use = function(player)
	...
	if player:hasItem(item.yname, 1) == true then
		if player:removeItemSlot(player.invSlot, 1) == true then
			player:addItem(303001, 3)
			player:sendMinitext("You open the package and find 3 Beta Mount Boxes!")
...
use = function(player)
	...
	if player:hasItem(item.yname, 1) == true then
		if player:removeItemSlot(player.invSlot, 1) == true then
			player:addItem(303001, 5)
			player:sendMinitext("You open the package and find 5 Beta Mount Boxes!")
			finishedQuest(player)
		end
	end
end
