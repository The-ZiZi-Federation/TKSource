...
animation = function(npc)
	...
	if getPass(m, x, y-1) == 0 then npc:sendAnimationXY(48, x, y-1, 1) npc:sendAnimationXY(305, x, y-1, 1) end
	if getPass(m, x, y+1) == 0 then	npc:sendAnimationXY(48, x, y+1, 1) npc:sendAnimationXY(305, x, y+1, 1) end
	if getPass(m, x+1, y) == 0 then npc:sendAnimationXY(48, x+1, y, 1) npc:sendAnimationXY(305, x+1, y, 1) end
	if getPass(m, x-1, y) == 0 then	npc:sendAnimationXY(48, x-1, y, 1) npc:sendAnimationXY(305, x-1, y, 1) end
	
	for i = 1, reg do	
		if getPass(m, x, y-(i)) == 0 then npc:sendAnimationXY(48, x, y-(i), 1) npc:sendAnimationXY(305, x, y-(i), 1) end
		if getPass(m, x, y+(i)) == 0 then	npc:sendAnimationXY(48, x, y+(i), 1) npc:sendAnimationXY(305, x, y+(i), 1) end
		if getPass(m, x+(i), y) == 0 then npc:sendAnimationXY(48, x+(i), y, 1) npc:sendAnimationXY(305, x+(i), y, 1) end
		if getPass(m, x-(i), y) == 0 then	npc:sendAnimationXY(48, x-(i), y, 1) npc:sendAnimationXY(305, x-(i), y, 1) end
	end
end,
