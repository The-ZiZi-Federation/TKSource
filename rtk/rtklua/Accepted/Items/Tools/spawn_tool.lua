...
click = async(function(player, npc)
	...
	local opts = {}
	table.insert(opts, "Red script ("..#red..")   : "..player.registry["red_script_num"])
	table.insert(opts, "Blue script ("..#blue..")  : "..player.registry["blue_script_num"])
	table.insert(opts, "Green script ("..#green..") : "..player.registry["green_script_num"])
	
	table.insert(opts, "Orange script ("..#orange..") : "..player.registry["orange_script_num"])
	table.insert(opts, "Yellow script ("..#yellow..") : "..player.registry["yellow_script_num"])
	table.insert(opts, "Pink script ("..#pink..") : "..player.registry["pink_script_num"])
	
	table.insert(opts, "Randomly place scrolls on map")

	menu = player:menuString("Set amount of scrolls to place randomly", opts)

	if menu == "Red script ("..#red..")   : "..player.registry["red_script_num"] then
		num = math.floor(tonumber(player:input("Enter amount : ("..player.registry["red_script_num"]..")")))
		player.registry["red_script_num"] = num

	elseif menu == "Blue script ("..#blue..")  : "..player.registry["blue_script_num"] then
		num = math.floor(tonumber(player:input("Enter amount : ("..player.registry["blue_script_num"]..")")))
		player.registry["blue_script_num"] = num
		
	elseif menu == "Green script ("..#green..") : "..player.registry["green_script_num"] then
		num = math.floor(tonumber(player:input("Enter amount : ("..player.registry["green_script_num"]..")")))
		player.registry["green_script_num"] = num
	
	elseif menu == "Orange script ("..#orange..") : "..player.registry["orange_script_num"] then
		num = math.floor(tonumber(player:input("Enter amount : ("..player.registry["orange_script_num"]..")")))
		player.registry["orange_script_num"] = num
		
	elseif menu == "Yellow script ("..#yellow..") : "..player.registry["yellow_script_num"] then
		num = math.floor(tonumber(player:input("Enter amount : ("..player.registry["yellow_script_num"]..")")))
		player.registry["yellow_script_num"] = num
		
	elseif menu == "Pink script ("..#pink..") : "..player.registry["pink_script_num"] then
	...
	elseif menu == "Randomly place scrolls on map" then
		confirm = player:menuString("Are you sure you want to place these scrolls?", {"Yes", "No"})
		if confirm == "Yes" then
...
click = async(function(player, npc)
	...
	table.insert(opts, "Red script ("..#red..")   : "..player.registry["red_script"])
	table.insert(opts, "Blue script ("..#blue..")  : "..player.registry["blue_script"])
	table.insert(opts, "Green script ("..#green..") : "..player.registry["green_script"])
	table.insert(opts, "Orange script ("..#orange..") : "..player.registry["orange_script"])
	table.insert(opts, "Yellow script ("..#yellow..") : "..player.registry["yellow_script"])
	table.insert(opts, "Pink script ("..#pink..") : "..player.registry["pink_script"])
	...
	elseif menu == "Delete all scripts in map" then
		local script = {Item("red_script").id, Item("blue_script").id, Item("green_script").id, Item("orange_script").id, Item("pink_script").id, Item("yellow_script").id}	
